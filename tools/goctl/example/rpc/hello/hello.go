...
import (
	...
	"github.com/userzhangjinlong/go-zero/tools/goctl/example/rpc/hello/internal/config"
	greetServer "github.com/userzhangjinlong/go-zero/tools/goctl/example/rpc/hello/internal/server/greet"
